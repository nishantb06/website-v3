...
// This MUST stay in sync with lib/slugify.ts so that the slug produced by the
// vault indexer (file names + node ids) matches the slug the app resolves
...
export function wikiLinkToSlug(target) {
